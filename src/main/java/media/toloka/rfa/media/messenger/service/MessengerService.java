package media.toloka.rfa.media.messenger.service;

import media.toloka.rfa.media.messenger.model.ChatMessage;
import media.toloka.rfa.media.messenger.model.MessageRoom;
import media.toloka.rfa.media.messenger.repository.ChatRepository;
import media.toloka.rfa.media.messenger.repository.MessageRoomRepository;
import media.toloka.rfa.media.messenger.repository.MessengerRepository;
...
public class MessengerService {
    ...
    final Logger logger = LoggerFactory.getLogger(MessengerService.class);

    public List<Clientdetail> FindAllCorrespondentsList(Clientdetail cd) {
        List<Messages> messagesList = messengerRepository.findMessagesByFromOrTo(cd, cd);
